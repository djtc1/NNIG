//YOSSI ROZENBERG
//http://www.codeproject.com/csharp/csstatistics.asp
...
namespace NNIG_NeuralNetworkMath
{
    class NN_statistics
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="list">Recives a vector</param>
		public NN_statistics(params double[] list)
		{
		  this.list=list;
		}
        ...
        /// <summary>
        /// Compute the size os the design
        /// </summary>
        /// <returns></returns>
		public int length()
		{
        ...
        /// <summary>
        /// Compute the index standard of a given number of the design
        /// </summary>
        ...
        /// <param name="s"></param>
        /// <returns></returns>
		public double cov(NN_statistics s)
		{
			try
			{
        ...
        /// <param name="s2"></param>
        /// <returns></returns>
		public static double cov(NN_statistics s1,NN_statistics s2)
		{
			try
			{
        ...
        /// <returns></returns>
		public double r(NN_statistics design)
		{
			try
			{
        ...
        /// <returns></returns>
		public static double r(NN_statistics design1,NN_statistics design2)
		{
			try
			{
        ...
        /// <param name="design"></param>
        /// <returns></returns>
		public double a(NN_statistics design)
		{
			try
			{
        ...
        /// <param name="design2"></param>
        /// <returns></returns>
		public static double a(NN_statistics design1,NN_statistics design2)
		{
			try
			{
        ...
        /// <param name="design"></param>
        /// <returns></returns>
		public double b(NN_statistics design)
		{
        ...
        /// <param name="design2"></param>
        /// <returns></returns>
		public static double b(NN_statistics design1,NN_statistics design2)
		{
